...
- ~3,625 lines across 6 modules (1.3.0 cut):
  ...
  - `src/lang.cyr` (~446) — extension/shebang/content detection + ext-override table + filename-shape detection (1.2.6); LANG_COUNT 44 (1.3.4 added nix per vyakarana 2.1.2; 1.3.3 added vue/svelte per vyakarana 2.1.1; 1.3.2 added powershell/crystal/julia per vyakarana 2.1.0; 1.3.0 added cyml/llvm_ir + redirected `.cyml` from toml → cyml per vyakarana 1.9.0)
